...
class Model(nn.Module):
    ...
    def stage1(self, source, target, source_pose, target_pose, other_pose, same_person_pose, index, k, get_image=False):
        ...
        l1_loss_sum = sum([l*(i+1) for i, l in enumerate(l1_loss_list)])
        ...
        res = [[i.item() for i in l1_loss_list]]
